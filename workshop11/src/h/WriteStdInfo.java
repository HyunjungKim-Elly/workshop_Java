...
public class WriteStdInfo {
    public static void writeStdInfo(JPanel pane) {
        ...
        try {
        	...
        	//Student std = new Student();   // -<< I wrote the code, but Student 's information could not be saved.
            ...
            submit.addActionListener(e -> {
                try{
                	Student std = new Student();   //     --< and i changed that code here , now it can be saved
      ...
      System.out.println(stdInfoInput.size());
            });
            pane.validate();
            pane.repaint();
